...
In addition to writing the actual code, you need to demonstrate this code working by presenting your program to the class so that everyone can see what you completed.

Notice that this code uses the regular expressions that you wrote in Assignment 9 to capture the radius of a plant and the birth date of a person from Wikipedia. Lines 90-125 of the starter code are the most important for you to understand -- the functions from Assignment 9 and the `pa_list`.
